document.addEventListener('DOMContentLoaded', function () {
  ...
  //     headers: {
  //       Authorization:
  //         'AAAAODSD_mG6y0DksY3fptZjqqU3YUdr9zLCtA2isJlNRaofQqm7g3eOCtP9QM4wUFAvyocK5hk286wSuq9O23FH5PQ',
  //     },
  //   })
  ...
  //   axios
  //     .post('/api/auth/naver-login', userInfo)
  ...
  //           case 401:
  //             resultMessage.textContent = '닉네임이 존재하지 않습니다.';
  //             break;
  //           case 401:
  //             resultMessage.textContent = '이메일이 존재하지 않습니다.';
  //             break;
  //           case 500:
  //             resultMessage.textContent = '이메일이 존재하지 않습니다.';
  //             break;
